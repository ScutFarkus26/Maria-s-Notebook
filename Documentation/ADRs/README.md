...
**Data Layer:**
- [ADR-001](ADR-001-swiftdata-enum-pattern.md) — How to store enums in Core Data models
- [ADR-003](ADR-003-repository-pattern.md) — When to use repositories vs @FetchRequest
