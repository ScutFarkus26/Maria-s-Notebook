...
struct WorkConsolidationServiceDuplicateDetectionTests {
    ...
    @Test("finds duplicates with same title, studentLessonID, and workType")
    func findsDuplicatesWithMatchingCriteria() throws {
        ...
        let work1 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: studentLessonID)
        let work2 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: studentLessonID)
        let work3 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: studentLessonID)
    ...
    func doesNotConsolidateWithDifferentTitles() throws {
        ...
        let work1 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: studentLessonID)
        let work2 = WorkModel(title: "Science Practice", workType: .practice, studentLessonID: studentLessonID)
        context.insert(work1)
        context.insert(work2)
    ...
    func doesNotConsolidateWithDifferentStudentLessonIDs() throws {
        ...
        let work1 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: UUID())
        let work2 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: UUID())
        context.insert(work1)
        context.insert(work2)
    ...
    @Test("does not consolidate works with different workTypes")
    func doesNotConsolidateWithDifferentWorkTypes() throws {
        ...
        let work1 = WorkModel(title: "Math Practice", workType: .practice, studentLessonID: studentLessonID)
        let work2 = WorkModel(title: "Math Practice", workType: .research, studentLessonID: studentLessonID)
        context.insert(work1)
        context.insert(work2)
    ...
    func handlesNoDuplicatesGracefully() throws {
        ...
        let work1 = WorkModel(title: "Work A", workType: .practice)
        let work2 = WorkModel(title: "Work B", workType: .research)
        let work3 = WorkModel(title: "Work C", workType: .followUp)
        context.insert(work1)
        context.insert(work2)
        context.insert(work3)
...
struct WorkConsolidationServiceConsolidationLogicTests {
    ...
    func keepsEarliestCreatedAtAsCanonical() throws {
        ...
        let work1 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, createdAt: newDate)
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, createdAt: oldDate)
        context.insert(work1)
        context.insert(work2)
    ...
    func deletesDuplicatesAfterConsolidation() throws {
        ...
        for i in 1...5 {
            let work = WorkModel(title: "Duplicate Work", workType: .practice, studentLessonID: studentLessonID, notes: "Work \(i)")
            context.insert(work)
        }
    ...
    func returnsCorrectCountsForMultipleGroups() throws {
        ...
        let slID1 = UUID()
        for _ in 1...3 {
            let work = WorkModel(title: "Group A", workType: .practice, studentLessonID: slID1)
            context.insert(work)
        }
        ...
        let slID2 = UUID()
        for _ in 1...2 {
            let work = WorkModel(title: "Group B", workType: .research, studentLessonID: slID2)
            context.insert(work)
        }

        // Single work (no duplicates)
        let work = WorkModel(title: "Unique Work", workType: .followUp)
        context.insert(work)
...
struct WorkConsolidationServiceMergeBehaviorTests {
    ...
    func keepsEarliestAssignedAt() throws {
        ...
        let work1 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, assignedAt: lateDate)
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, assignedAt: earlyDate)
        context.insert(work1)
        context.insert(work2)
    ...
    func mergesNotesFromDuplicates() throws {
        ...
        let work1 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, notes: "")
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, notes: "Important note from duplicate")
    ...
    func preservesCompletionStatus() throws {
        ...
        let work1 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID)
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID, completedAt: completionDate)
...
struct WorkConsolidationServiceParticipantMergingTests {
    ...
    func mergesParticipantsFromDuplicates() throws {
        ...
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: studentLessonID)
        work2.participants = [
...
struct WorkConsolidationServiceEdgeCasesTests {
    ...
    func handlesNilStudentLessonID() throws {
        ...
        let work1 = WorkModel(title: "Practice", workType: .practice, studentLessonID: nil)
        let work2 = WorkModel(title: "Practice", workType: .practice, studentLessonID: nil)
        context.insert(work1)
        context.insert(work2)
    ...
    func handlesEmptyTitle() throws {
        ...
        let work1 = WorkModel(title: "", workType: .practice, studentLessonID: studentLessonID)
        let work2 = WorkModel(title: "", workType: .practice, studentLessonID: studentLessonID)
        context.insert(work1)
        context.insert(work2)
