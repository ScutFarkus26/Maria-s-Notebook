...
struct StudentDetailViewModelWorkMethodsTests {
    ...
    func updateWorkModelsSetsWorkModelsForStudent() throws {
        ...
        let work = makeTestWorkModel(title: "Practice", kind: .practiceLesson, studentID: student.id.uuidString)
        context.insert(work)
    ...
    func fetchWorkModelsForStudentReturnsNonComplete() throws {
        ...
        let activeWork = makeTestWorkModel(title: "Active", kind: .practiceLesson, status: .active, studentID: student.id.uuidString)
        let completeWork = makeTestWorkModel(title: "Complete", kind: .practiceLesson, status: .complete, studentID: student.id.uuidString)
    ...
    func fetchWorkReturnsWorkByID() throws {
        ...
        let work = makeTestWorkModel(title: "Test Work", kind: .practiceLesson)
        context.insert(work)
