...
struct AttendanceStoreTests {
    ...
    func updateNoteChanges() throws {
        ...
        #expect(changed == true)
        #expect(record.latestUnifiedNoteText == "Student arrived late")
    }
    ...
    func updateNoteTrimming() throws {
        ...
        #expect(record.latestUnifiedNoteText == "Note with spaces")
    }
    ...
    func updateNoteEmptyToNil() throws {
        ...
        let store = AttendanceStore(context: context)
        _ = store.updateNote(record, to: "Original note")
    ...
    func updateNoteUnchanged() throws {
        ...
        let store = AttendanceStore(context: context)
        _ = store.updateNote(record, to: "Same note")
