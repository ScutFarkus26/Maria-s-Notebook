...
private struct SubjectGrainPillPreviewsPreview: View {
    var body: some View {
        let areas = [
...
#Preview("Area Grain Pills") {
    SubjectGrainPillPreviewsPreview()
}

private struct SubjectGrainPillPreviewsPreview2: View {
    var body: some View {
        let areas = [
...
#Preview("Pattern Comparison") {
    SubjectGrainPillPreviewsPreview2()
}
