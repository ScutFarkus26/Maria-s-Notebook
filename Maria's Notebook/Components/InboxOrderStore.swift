...
//
//  Provides utilities to parse, serialize, and order unscheduled LessonAssignment instances
...
enum InboxOrderStore {
    ...
    static func orderedUnscheduled(from all: [LessonAssignment], orderRaw: String) -> [LessonAssignment] {
