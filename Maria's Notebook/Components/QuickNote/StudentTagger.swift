...
private enum PatternMatchHelpers {
    nonisolated static func containsWithBoundary(source: String, pattern: String) -> Bool {
        do {
            ...
            print("⚠️ [\(#function)] Failed to create regex with pattern '\(pattern)': \(error)")
            return false
        }
    }
    ...
    func formatStudentNames(in text: String, studentData: [StudentData]) -> String {
        ...
        for searchTerm in terms {
            ...
            do {
                ...
                print("⚠️ [\(#function)] Failed to create regex for term '\(searchTerm.term)': \(error)")
            }
        }
    ...
    private func generateReplacements(
        ...
        for studentID in exactMatches {
            ...
            let isAlreadyReplaced: (String) -> Bool = { matchedText in
                ...
                if replacementTrimmed.hasSuffix(".") {
                    ...
                    do {
                        ...
                        print("⚠️ [\(#function)] Failed to create regex for pattern '\(expectedPattern)': \(error)")
                    }
                }
            ...
            do {
                ...
                print("⚠️ [\(#function)] Failed to create regex for full name pattern: \(error)")
            }
            ...
            do {
                ...
                print("⚠️ [\(#function)] Failed to create regex for first+last initial pattern: \(error)")
            }
            ...
            if firstNameCounts[firstLower] ?? 0 == 1 {
                ...
                do {
                    ...
                    print("⚠️ [\(#function)] Failed to create regex for first name pattern: \(error)")
                }
            }
            ...
            if !nick.isEmpty {
                ...
                do {
                    ...
                    print("⚠️ [\(#function)] Failed to create regex for nickname pattern: \(error)")
                }
            }
        }
