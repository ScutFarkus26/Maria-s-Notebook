...
struct AttendanceView: View {
    ...
    private var isNonSchoolDay: Bool {
        isNonSchoolDaySync(viewModel.selectedDate)
    }
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            let coerced = nearestSchoolDaySync(to: viewModel.selectedDate)
    ...
    private var regularHeader: some View {
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                Button {
                    let prev = previousSchoolDaySync(before: viewModel.selectedDate)
                ...
                Button {
                    let next = nextSchoolDaySync(after: viewModel.selectedDate)
