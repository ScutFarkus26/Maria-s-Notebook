...
struct SchoolCalendar {
    ...
    static func precomputedNonSchoolSet(in range: Range<Date>, using context: ModelContext) async -> Set<Date> {
    ...
    static func nonSchoolDays(in range: Range<Date>, using context: ModelContext) async -> Set<Date> {
        await SchoolCalendarService.shared.nonSchoolDays(in: range, using: context)
    }

    /// Toggle the non-school state for a date.
    @discardableResult
    static func toggleNonSchoolDay(_ date: Date, using context: ModelContext) async throws -> Bool {
    ...
    static func nextSchoolDay(after date: Date, using context: ModelContext) async -> Date {
    ...
    static func previousSchoolDay(before date: Date, using context: ModelContext) async -> Date {
    ...
    static func nearestSchoolDay(to date: Date, using context: ModelContext) async -> Date {
